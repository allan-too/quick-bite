...
import { Facebook, Twitter, Instagram, Mail, Smartphone } from 'lucide-react';
    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">QuickBite</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/rider-registration" className="text-gray-300 hover:text-white transition-colors">
                  Become a Rider
                </Link>
              </li>
              <li>
